#Series de tiempo v2 | NINFAS 2024
...
data <- read.csv("C:\\Users\\Tacos\\OneDrive\\Documentos\\Universidad\\Servicio Social\\Datos\\CL-NINFAS 2024.csv")
head(data)
...
data$timeObj<-as.POSIXct(data$Fecha + data$Horas)

# Eliminar filas con NA usando complete.cases()
